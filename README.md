...
## 🌱 Aprendizado Atual
- Python avançado  
- Data Analytics e Estatística  
- Banco de Dados (MySQL, PostgreSQL, SQL Server)  
- Automação de processos e dashboards interativos (Streamlit)

---

## 👨‍💻 Meus Projetos
- [Repositórios no GitHub](https://github.com/GABRIELWCS?tab=repositories)
...
- LinkedIn: [Gabriel Souza](https://www.linkedin.com/in/gabriel-souza-553224247/?isSelfProfile=true)
